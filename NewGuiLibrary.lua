if shared.Matr1xExecuted then
	...
	local translations = {}--loadstring(GetURL("translations/"..api["Language"]..".Matr1xtranslation") or GetURL("translations/en-us.Matr1xtranslation"))()
	--local translatedlogo, res = pcall(function() return GetURL("translations/"..api["Language"].."/Matr1xLogo1.png") end)
	...
	coroutine.resume(coroutine.create(function()
		...
		until not shared.Matr1xExecuted
	end))
	...
	api["SaveSettings"] = function()
		if loadedsuccessfully then
			writefile(customdir.."Profiles/"..(shared.CustomSaveMatr1x or game.PlaceId)..".Matr1xprofiles.txt", game:GetService("HttpService"):JSONEncode(api["Profiles"]))
			local WindowTable = {}
			...
			writefile(customdir.."Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveMatr1x or game.PlaceId)..".Matr1xprofile.txt", game:GetService("HttpService"):JSONEncode(api["Settings"]))
			writefile(customdir.."Profiles/"..(game.GameId).."GUIPositions.Matr1xprofile.txt", game:GetService("HttpService"):JSONEncode(WindowTable))
		end
	end
	...
	api["LoadSettings"] = function(customprofile)
		if identifyexecutor and identifyexecutor():find("ScriptWare") == nil and listfiles then
			for i,v in pairs(listfiles(customdir.."Profiles")) do 
				...
				if (ext and ext:find("Matr1xprofile") and ext:find("txt") == nil) then
		...
		local success2, result2 = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(shared.CustomSaveMatr1x or game.PlaceId)..".Matr1xprofiles.txt"))
		end)
		...
		local success3, result3 = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(game.GameId).."GUIPositions.Matr1xprofile.txt"))
		end)
		...
		local success, result = pcall(function()
			return game:GetService("HttpService"):JSONDecode(readfile(customdir.."Profiles/"..(api["CurrentProfile"] == "default" and "" or api["CurrentProfile"])..(shared.CustomSaveMatr1x or game.PlaceId)..".Matr1xprofile.txt"))
		end)
	...
	api["SwitchProfile"] = function(profilename)
		...
		if (not betterisfile(customdir.."Profiles/"..(profilename == "default" and "" or profilename)..(shared.CustomSaveMatr1x or game.PlaceId)..".Matr1xprofile.txt")) then
	...
	api["CreateMainWindow"] = function()
		...
		windowapi["CreateCustomToggle"] = function(argstable)
			...
			api["ObjectsThatCanBeSaved"]["Matr1xSettings"..argstable["Name"].."Toggle"] = {["Type"] = "Toggle", ["Object"] = buttontext, ["Api"] = buttonapi}
			return buttonapi
		end
			...
			sliderapi["SetRainbow"] = function(val)
				...
				if sliderapi["RainbowValue"] then
					...
					heh = coroutine.resume(coroutine.create(function()
						...
						until sliderapi["RainbowValue"] == false or shared.Matr1xExecuted == nil
					end))
				end
			end
